...
show_data = st.checkbox("Show World Cup Data")
show_summary = st.checkbox("Show Data Summary")

#My Data
import os
print(os.getcwd())
df = pd.read_csv("Worldcup Data.csv")
...
if page == "Introduction":
    st.write("📊World Cup Data📊 (1990-2022)", df if show_data else "")
    if show_summary:
...
st.write("Brazil stands tall as the overall ings of football, while teams like Germany and Italy follow suite.")
